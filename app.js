...
const superheroSchema = new mongoose.Schema(
  {
    ...
    createdBy: { type: String, default: "Dilan" },
  },
...
async function insertSuperHero() {
  try {
    const hero = new SuperHero({
        nombreSuperHeroe: "El increíble Hulk",
        nombreReal: "Dr. Robert Bruce Banner",
        edad: 36,
        planetaOrigen: "Tierra",
        debilidad: ["rayos cósmicos "],
        poderes: ["Enorme fuerza","reisitencia a las heridas"],
        aliados: [" Los Vengadores"],
        enemigos: ["thanos"],
      });      
